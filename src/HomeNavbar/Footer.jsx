        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
          ...
          <div className="flex-1 max-w-lg text-center lg:text-left">
            ...
            <p className="text-[#A9A9A9] text-base sm:text-lg mb-6">
              Get the best value, legal protection, and environmental peace of
              mind
            </p>
          ...
          <div className="bg-white text-black p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <p className="text-xs text-[#36D16A] mb-2 font-semibold">
              Government Certified
            </p>
            <p className="text-sm text-gray-700 leading-relaxed mb-4">
              Don't risk illegal scrapping!{" "}
              <span className="font-bold">Only authorized facilities</span> like
              ours can provide official certificates and legal protection.
            </p>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              Kanhaautodeals is a fully licensed registered Vehicle Scrapping
              Facility (RVSF), authorized under the Vehicle Scrapping Policy,
              2021...
              <a href="#" className="text-[#36D16A] hover:underline">
                {" "}
                read more.
              </a>
            </p>
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              <p>
                <span className="text-[#36D16A]">📞</span> +917303361200 <br />
                <span className="text-xs">Mon-Sat, 9:00 AM - 6:00 PM</span>
              </p>
              <p>
                <span className="text-[#36D16A]">📧</span>{" "}
                mykanhaautodeals@gmail.com
              </p>
              <p>
                <span className="text-[#36D16A]">📍</span> 3rd Floor, 134,
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <Link to="/process">
                <li className="hover:text-white">Vehicle Scrapping Process</li>
              </Link>
              <Link to="/privacy">
