      ...
      <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto pt-16 px-8">
        <div className="md:w-1/2">
          ...
          <p className="text-gray-700 text-lg mt-4 mb-2">
            ...
            Government agencies are actively seizing end-of-life vehicles across
            Delhi-NCR without prior notice. Protect your investment before it's
            too late.
        ...
        <div className="md:w-1/2 flex justify-center mt-8 md:mt-0 ">
          <img
            src={`${import.meta.env.BASE_URL}assets/SeizedVehicle.png`}
